          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                <div>
                  <button className="bg-gradient-to-r from-green-500 to-green-700 text-white py-2 px-4 rounded-full
                   shadow-2xl hover:shadow-md hover:scale-105 duration-300">
                    Order Now
                  </button>
                </div>
              </div>
